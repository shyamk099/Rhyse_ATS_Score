"""Unit tests for the metadata of the ExperienceScorer.
...
class ExperienceMetadataTests(unittest.TestCase):
    """Test suite validating ExperienceScorer metadata fields."""

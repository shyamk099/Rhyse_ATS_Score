"""Pipeline integration tests executing EducationScorer.

Purpose:
    Verify core ScoringPipeline execution utilizing registered EducationScorer,
    generating populated education SectionScores in sequential pipeline flow.
"""
...
class EducationPipelineTests(unittest.TestCase):
    """Test suite validating ScoringPipeline integration with EducationScorer."""

    def test_pipeline_integration_with_education_scorer(self) -> None:
        ...
        results = [
            ...
            make_mock_edu_result("M-ED2", "MSc", "MSc", match_type="RELATED_FIELD"),
        ]
        ...
        # Education Score should be populated: 1 exact (4.0) + 1 related (2.5) = 6.5
        ...
        self.assertEqual(15.0, res.education_score.maximum_score)

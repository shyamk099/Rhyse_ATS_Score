"""Tests for ProjectRecommendationProvider thread safety.
...
class ProjectProviderThreadSafetyTests(unittest.TestCase):
    """Tests checking concurrent execution safety for project provider."""

"""Tests for EducationRecommendationProvider thread safety.
...
class EducationProviderThreadSafetyTests(unittest.TestCase):
    """Tests checking concurrent execution safety for education provider."""

"""Tests for SkillRecommendationProvider thread safety.

Purpose:
    Verify concurrent generate() executions return isolated recommendation tuples.
"""
...
class SkillProviderThreadSafetyTests(unittest.TestCase):
    """Tests checking concurrent execution safety for skill provider."""
    ...
    def test_concurrent_generate_calls_are_isolated(self) -> None:
        """All threads executing generate() concurrently must succeed with independent tuples."""

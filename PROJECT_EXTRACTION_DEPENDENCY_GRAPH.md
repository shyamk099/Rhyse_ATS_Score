# Project Extraction Dependency Graph
...
graph LR
    subgraph "Milestone 3.7 - Project Extraction"
        SVC["ProjectExtractionService"]
        PL["ProjectExtractionPipeline"]
        CB["ProjectCandidateBuilder"]
        CV["ProjectCandidateValidator"]
        NR["ProjectNormalizer"]
        AS["ProjectAssembler"]
        EB["ProjectEntityBuilder"]
        MD["Project Models"]
        RL["ProjectExtractionRules"]
        EX["Project Exceptions"]
    end

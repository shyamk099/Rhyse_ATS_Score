# Experience Extraction Dependency Graph
...
graph LR
    subgraph "Milestone 3.5 - Experience Extraction"
        SVC["ExperienceExtractionService"]
        PL["ExperienceExtractionPipeline"]
        CB["ExperienceCandidateBuilder"]
        CV["ExperienceCandidateValidator"]
        NR["ExperienceNormalizer"]
        AS["ExperienceAssembler"]
        EB["ExperienceEntityBuilder"]
        MD["Experience Models"]
        RL["ExperienceExtractionRules"]
        EX["Experience Exceptions"]
    end

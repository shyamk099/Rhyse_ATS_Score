# Education Extraction Package Diagram
...
graph TB
    subgraph "ats_engine.domain.entity_extraction.education"
        ...
        SVC["service.py<br/>(EducationExtractionService)"]
        PL["pipeline.py<br/>(EducationExtractionPipeline)"]
        CB["education_candidate_builder.py<br/>(EducationCandidateBuilder)"]
        CV["education_candidate_validator.py<br/>(EducationCandidateValidator)"]
        NR["education_normalizer.py<br/>(EducationNormalizer)"]
        AS["education_assembler.py<br/>(EducationAssembler)"]
        EB["education_entity_builder.py<br/>(EducationEntityBuilder)"]
        MD["education_models.py<br/>(Domain Models)"]
        RL["education_rules.py<br/>(EducationExtractionRules)"]

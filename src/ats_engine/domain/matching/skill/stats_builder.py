"""Structural statistics builder for Skill matches.
...
class SkillMatchStatisticsBuilder:
    """Builder compiling structural metrics for Skill matching execution runs."""

"""Structural statistics builder for Project matches.
...
class ProjectMatchStatisticsBuilder:
    """Builder compiling structural metrics for Project matching execution runs."""

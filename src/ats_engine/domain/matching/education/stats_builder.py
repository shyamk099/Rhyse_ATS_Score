"""Structural statistics builder for Education matches.
...
class EducationMatchStatisticsBuilder:
    """Builder compiling structural metrics for Education matching execution runs."""

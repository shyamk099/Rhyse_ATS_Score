# Experience Extraction Package Diagram
...
graph TB
    subgraph "ats_engine.domain.entity_extraction.experience"
        ...
        SVC["service.py<br/>(ExperienceExtractionService)"]
        PL["pipeline.py<br/>(ExperienceExtractionPipeline)"]
        CB["experience_candidate_builder.py<br/>(ExperienceCandidateBuilder)"]
        CV["experience_candidate_validator.py<br/>(ExperienceCandidateValidator)"]
        NR["experience_normalizer.py<br/>(ExperienceNormalizer)"]
        AS["experience_assembler.py<br/>(ExperienceAssembler)"]
        EB["experience_entity_builder.py<br/>(ExperienceEntityBuilder)"]
        MD["experience_models.py<br/>(Domain Models)"]
        RL["experience_rules.py<br/>(ExperienceExtractionRules)"]

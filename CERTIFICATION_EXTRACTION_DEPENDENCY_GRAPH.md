# Certification Extraction Dependency Graph
...
graph LR
    subgraph "Milestone 3.8 - Certification Extraction"
        SVC["CertificationExtractionService"]
        PL["CertificationExtractionPipeline"]
        CB["CertificationCandidateBuilder"]
        CV["CertificationCandidateValidator"]
        NR["CertificationNormalizer"]
        AS["CertificationAssembler"]
        EB["CertificationEntityBuilder"]
        MD["Certification Models"]
        RL["CertificationExtractionRules"]
        EX["Certification Exceptions"]
    end

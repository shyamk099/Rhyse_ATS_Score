# Education Extraction Component Diagram
...
graph TB
    ...
    subgraph "Education Extraction Module"
        SERVICE["EducationExtractionService<br/>(Public Facade)"]
        PIPELINE["EducationExtractionPipeline<br/>(Orchestrator)"]

        subgraph "Processing Stages"
            CB["EducationCandidateBuilder<br/>(Evidence Scanner)"]
            CV["EducationCandidateValidator<br/>(Structure Check)"]
            NR["EducationNormalizer<br/>(Field Cleaner)"]
            AS["EducationAssembler<br/>(Record Grouper)"]
            EB["EducationEntityBuilder<br/>(Confidence Scorer)"]
        end

        subgraph "Configuration"
            RULES["EducationExtractionRules<br/>(Rule Engine Schema)"]
        end

        subgraph "Domain Models"
            CAND["EducationCandidate"]
            NORM["NormalizedEducation"]
            ASMB["AssembledEducation"]
            ENT["EducationEntity"]
            COLL["EducationCollection"]
